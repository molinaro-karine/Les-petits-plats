...
// boucle à travers toutes les recettes (de recipe.js)
...
function availableFilters(list, typeOfFilter) {
    ...
    list.forEach(choice => {
        ...
        p.addEventListener('click', (e) =>{
            ...
            // recalcule les résultats lors de la suppression d'un tag
...
// fonction pour recalculer les résultats lors de la suppression d'un tag
...
filterInputIngredients.addEventListener("keyup", (e)=> {
    if(e.target.value.length>2){ // plus de 2 caractères donc minimum 3
